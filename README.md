...
(3) change directory to the folder containing SIRIUS.exe, and use the following command to calculate fingerprints.
    ...
    sirius -i "D:\GitHub\MSFragTox\MSFragTox_prediction\test examples\test1 6ppdq\test1_6ppdq.mgf" -o "D:\GitHub\MSFragTox\MSFragTox_prediction\test examples\test1 6ppdq\6ppdq SIRIUS result" formula fingerprint
...
**Command:**
    ...
    python MSFragTox_predict.py -i "D:\GitHub\MSFragTox\MSFragTox_prediction\test examples\test1 6ppdq\6ppdq SIRIUS result" -o "D:\GitHub\MSFragTox\MSFragTox_prediction\test examples\test1 6ppd"
